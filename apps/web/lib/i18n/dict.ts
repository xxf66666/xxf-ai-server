...
export const en = {
  ...
  'keys.minted.title': 'New API key minted',
  'keys.minted.warning':
    "Copy it now — this is the only time you'll see the full value. We store a one-way hash; even an admin cannot recover it.",
  'keys.minted.copied': 'Copied',
  'keys.minted.copyFailed': 'Copy blocked by browser — select & copy manually.',
  'keys.col.name': 'Name',
  'keys.col.key': 'Key',
...
export const zh: Dict = {
  ...
  'keys.minted.title': '新 API Key 已签发',
  'keys.minted.warning': '立刻复制 —— 完整值只显示这一次。我们只保存单向哈希，连管理员也找不回。',
  'keys.minted.copied': '已复制',
  'keys.minted.copyFailed': '浏览器拒绝写剪贴板，请手动选中复制。',
  'keys.col.name': '名称',
  'keys.col.key': '密钥',
  'keys.col.status': '状态',
  'keys.col.used': '已用',
